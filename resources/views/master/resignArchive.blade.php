...
@section('content')
    ...
    <div class="page-content" id="app">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Archive Exit Form Ba</span>
            </li>
        </ul>
        <!-- END PAGE BREADCRUMB -->
                ...
                <div class="portlet light portlet-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red sbold uppercase">Data Archive Exit Form Ba</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <table class="table table-striped table-hover table-bordered" id="archiveTable">
                            <thead>
                            <tr>
                                <th> Id </th>
                                <th> Nama Ba </th>
...
@section('additional-script')
    ...
    <script>
        ...
        let tableColumns = [
            ...
            {title: 'Nama Ba', name: 'ba.name', data: 'ba.name', class:'namewrapper'},
            {title: 'Nama Toko', name: 'stores', data: 'stores', class: 'namewrapper'},
            {title: 'Download', name: 'aksi', data: 'aksi', orderable: false, searchable: false, class: 'namewrapper'},
        ]
